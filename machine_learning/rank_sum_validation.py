...
rank_sum = pd.read_csv("/mnt/storage2/users/ahnelll1/master_thesis/training_data/NEPdb_neofox_annotations_rank_sum_out_25.tsv", sep="\t", header=0).sort_values(by=['patientIdentifier'])

# Test Set
pred_labels = [0 if qscore < 0.7 else 1 for qscore in rank_sum["qscore"]]
