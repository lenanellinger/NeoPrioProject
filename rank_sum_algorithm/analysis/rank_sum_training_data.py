...
rank_sum = pd.read_csv(f"/mnt/storage2/users/ahnelll1/master_thesis/training_data/NEPdb_neofox_annotations_rank_sum_weighted_out_{step_size}.tsv", sep="\t", header=0).sort_values(by=['patientIdentifier'])
