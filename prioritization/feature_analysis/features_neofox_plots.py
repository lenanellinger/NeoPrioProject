...
output_dir = "/mnt/storage2/users/ahnelll1/master_thesis/NeoPrioProject/prioritization/feature_analysis/images/neofox"

def main(argv):
    usage = "usage: python features_neofox_plots.py --prefilter --use-interval"
    desc = "Creates plots for neofox features."
    parser = OptionParser(usage=usage, description=desc)
    parser.add_option("--prefilter", action="store_true", dest="prefilter", default=False, help="If neoantigens should be filtered by binding prefilter")
