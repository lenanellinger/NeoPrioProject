...
def main():
    ...
    samples = pd.read_csv('/mnt/storage2/users/ahnelll1/master_thesis/NeoPrioProject/prioritization/weight_calculation/data/NECID_Query.csv')
    ...
    plt.savefig("/mnt/storage2/users/ahnelll1/master_thesis/NeoPrioProject/prioritization/weight_calculation/images/NEPdb_antigen_len.png")
    ...
    samples_updated_df.to_csv('/mnt/storage2/users/ahnelll1/master_thesis/NeoPrioProject/prioritization/weight_calculation/data/NECID_Query_updated.csv', index=False)
